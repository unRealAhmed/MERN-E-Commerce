          ...
          >
            <tr>
              ...
              <td>
                ...
                Did you forget your password for E-Commerce? No worries—we're here to help! Click the link below to reset your password and regain access to your account.
                
                [Reset Password Link]
                
                If you didn't request a password reset, please ignore this email. Ensuring the security of your E-Commerce account is our top priority.
            ...
            <tr>
              <td>
                <a
                  href="http://localhost:3000/api/v1/users/resetPassword/${forgotPasswordToken}"
                  style="
